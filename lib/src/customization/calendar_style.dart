...
class CalendarStyle {
  ...
  /// TextStyle for day cells,on hover state
  ...
  /// Decoration for day cells,on hover state
  ...
  const CalendarStyle({
    ...
    this.hoveredTextStyle = const TextStyle(color: Color.fromARGB(255, 102, 212, 122)),
    this.hoveredDecoration = const BoxDecoration(
        color: Color(0xFF1118DA), shape: BoxShape.rectangle),
